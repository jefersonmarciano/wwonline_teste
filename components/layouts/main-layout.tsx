...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  const navItems = [
    ...
    { href: "/draft/create", label: "Criar Draft", icon: Gamepad2 },
    { href: "/draft/join", label: "Entrar Draft", icon: Gamepad2 },
    ...
    <div className="min-h-screen bg-background flex">
      ...
      >
        <div className="h-full flex flex-col">
          ...
          {user?.playerId && (
            <div className="p-4 mt-2 mx-4 mb-4 bg-muted/50 rounded-md">
              <p className="text-sm">
                <span className="font-medium">ID:</span> {user.playerId}
              </p>
            </div>
          )}
